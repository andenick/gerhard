...
|-------|-------|
| Series ID | S018 |
| Name | National Accounts Panel |
| Description | GDP components, savings, investment, government consumption from WDI |
| Content Type | time_series |
| Tier | 1 |
| Module | global_comparative |
| Source | World Bank WDI |
| Units | mixed (percent_gdp, current_usd) |
...
| Phase | Script | Path |
|-------|--------|------|
| Loading | L85 | Technical/src/pipeline/L_load/L85_*.py |
| Processing | P97 | Technical/src/pipeline/P_process/P97_*.py |
...
1. **L85** → Fetch data from World Bank WDI
2. **P97** → Clean, standardize, merge into panel format
3. **Output** → 

"""
Pipeline: Analyze Tax Burden Distribution
...
MANIFEST = {
    "id": "A00",
    "name": "Analyze Tax Burden Distribution",
    "stage": "A",
    "description": "Analyzes tax burden distribution across income classes using US and international data.",
    "depends_on": ["P00", "L40"],
    "inputs": [
        ...
        {"path": "Output/Data/us_tax_distribution_by_income_quintile.xlsx", "required": False, "description": "US tax distribution by quintile"},
        ...
        {"path": "Output/Data/world_bank_tax_revenue.xlsx", "required": False, "description": "World Bank tax revenue"},
        {"path": "Output/Data/unified_international_tax_data.xlsx", "required": False, "description": "Unified international data"},
    ],
    "outputs": [
        {"path": "Output/Data/analysis_us_tax_burden_distribution.xlsx", "description": "US tax burden analysis"},
        {"path": "Output/Data/analysis_tax_progressivity.xlsx", "description": "Tax progressivity analysis"},
        {"path": "Output/Data/analysis_international_tax_levels.xlsx", "description": "International tax level comparison"},
        {"path": "Output/Data/analysis_tax_burden_by_type.xlsx", "description": "Tax burden by type analysis"},
        {"path": "Output/Data/analysis_summary_findings.xlsx", "description": "Summary of key findings"},
    ],
    "timeout": 120,
    "parallel_safe": True,
}

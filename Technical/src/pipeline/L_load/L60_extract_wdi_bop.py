#!/usr/bin/env python3
"""
L60: Extract WDI Balance of Payments
Current account, FDI, portfolio flows, and financial account from WDI.
Stage: L | ID: L60
Project: Gerhard
"""
import os
...
MANIFEST = {
    "id": "L60",
    "name": "Extract WDI Balance of Payments",
    "stage": "L",
    "description": "Current account, FDI, portfolio flows, and financial account from WDI",
    "depends_on": [],
    "inputs": [],
    "outputs": [{"path": "Technical/data/processed/wdi_bop_detail.xlsx"}],
    "timeout": 180,
    "parallel_safe": True,
}
...
INDICATORS = {
    ...
    'BX.GSR.FCTY.CD': 'primary_income_receipts_usd',
    'BM.GSR.FCTY.CD': 'primary_income_payments_usd',
    ...
    'BM.KLT.DINV.CD.WD': 'fdi_outflows_usd',
    'BN.KLT.PTXL.CD': 'portfolio_investment_net_usd',
    'BN.FIN.TOTL.CD': 'financial_account_net_usd',
    'BN.RES.INCL.CD': 'reserves_related_usd',
    'BN.KAC.EOMS.CD': 'errors_omissions_usd',
}

OUTPUT_FILENAME = 'wdi_bop_detail.xlsx'

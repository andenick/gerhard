#!/usr/bin/env python3
"""
L85: Extract WDI National Accounts
GDP composition by expenditure and sector from WDI.
Stage: L | ID: L85
Project: Gerhard
"""
import os
...
MANIFEST = {
    "id": "L85",
    "name": "Extract WDI National Accounts",
    "stage": "L",
    "description": "GDP composition by expenditure and sector from WDI",
    "depends_on": [],
    "inputs": [],
    "outputs": [{"path": "Technical/data/processed/wdi_national_accounts.xlsx"}],
    "timeout": 180,
    "parallel_safe": True,
}
...
OUTPUT_FILENAME = 'wdi_national_accounts.xlsx'

#!/usr/bin/env python3
"""
L70: Extract WDI Exchange Rates
Exchange rates, REER, CPI, inflation, and GDP deflator from WDI.
Stage: L | ID: L70
Project: Gerhard
"""
import os
...
MANIFEST = {
    "id": "L70",
    "name": "Extract WDI Exchange Rates",
    "stage": "L",
    "description": "Exchange rates, REER, CPI, inflation, and GDP deflator from WDI",
    "depends_on": [],
    "inputs": [],
    "outputs": [{"path": "Technical/data/processed/wdi_exchange_rates.xlsx"}],
    "timeout": 180,
    "parallel_safe": True,
}
...
OUTPUT_FILENAME = 'wdi_exchange_rates.xlsx'

#!/usr/bin/env python3
"""
L79: Extract WDI Labor
Unemployment, labor force participation, and employment by sector from WDI.
Stage: L | ID: L79
Project: Gerhard
"""
import os
...
MANIFEST = {
    "id": "L79",
    "name": "Extract WDI Labor",
    "stage": "L",
    "description": "Unemployment, labor force participation, and employment by sector from WDI",
    "depends_on": [],
    "inputs": [],
    "outputs": [{"path": "Technical/data/processed/wdi_labor.xlsx"}],
    "timeout": 180,
    "parallel_safe": True,
}
...
INDICATORS = {
    ...
    'SL.UEM.TOTL.FE.ZS': 'unemployment_female_pct',
    'SL.UEM.TOTL.MA.ZS': 'unemployment_male_pct',
...
OUTPUT_FILENAME = 'wdi_labor.xlsx'

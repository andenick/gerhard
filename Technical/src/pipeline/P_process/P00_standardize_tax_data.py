"""
Pipeline: Standardize Tax Data
Standardizes and processes international taxation data from raw downloads.
Project: Gerhard
"""
...
MANIFEST = {
    "id": "P00",
    "name": "Standardize Tax Data",
    "stage": "P",
    "description": "Processes and standardizes World Bank tax data into clean Excel outputs.",
    "depends_on": ["L00"],
    "inputs": [
        {"path": "Technical/data/raw/worldbank_tax_revenue.csv", "required": True, "description": "World Bank tax revenue CSV"},
    ],
    "outputs": [
        {"path": "Output/Data/world_bank_tax_revenue.xlsx", "description": "Cleaned World Bank tax revenue"},
        {"path": "Output/Data/unified_international_tax_data.xlsx", "description": "Unified international tax dataset"},
        {"path": "Output/Data/data_summary_statistics.xlsx", "description": "Summary statistics across sources"},
    ],
    "timeout": 300,
    "parallel_safe": True,
}
